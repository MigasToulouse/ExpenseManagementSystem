...
from expense_management_system import consts
from expense_management_system.utils.logging import get_logger, timing_context
...
@patch("expense_management_system.utils.logging.time.time", MagicMock(side_effect=[100.0, 101.0]))
